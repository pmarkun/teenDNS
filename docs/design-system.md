...
- As regras continuam como uma lista linear, preservando nome e ação.
...
- `teenDNS`
- `como funciona`, `configurar`, `abrir painel`
- `Cuidar da internet sem vigiar.`
- `O teenDNS ajuda famílias a observar, conversar e proteger — usando apenas o endereço dos serviços, nunca mensagens ou páginas.`
- `entender em 1 minuto`
...
O painel inicial não mostra motivo por regra, regeneração de hostname, histórico,
passo a passo ou controles avançados. Esses elementos continuam disponíveis em
gavetas ou páginas secundárias, sem competir com a tarefa principal.

## Referências de implementação

- [`admin-dashboard.png`](../design/concepts/admin-dashboard.png): viewport `1440 × 900`.
- [`explainer-page.png`](../design/concepts/explainer-page.png): viewport `1440 × 1000`.
